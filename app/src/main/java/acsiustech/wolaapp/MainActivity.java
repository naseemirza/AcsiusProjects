...
public class MainActivity extends AppCompatActivity
    ...
    private static final Integer[] XMEN= {R.drawable.banner1,R.drawable.banner1,R.drawable.banner1,R.drawable.banner1,R.drawable.banner1};
...
//        });
       ...
       // navMenuView.addItemDecoration(new DividerItemDecoration(MainActivity.this,DividerItemDecoration.VERTICAL));
        ...
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Lounge Chair","$","110.00"));
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Wing Chair","$","110.00"));
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Shell Chair","$","110.00"));
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Rocking Chair","$","110.00"));
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Jarvis Chair","$","110.00"));
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Lounge Chair","$","110.00"));
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Shell Chair","$","110.00"));
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Wing Chair","$","110.00"));
        productList.add(new NewCollcModel(R.drawable.lounge_chair,"Rocking Chair","$","110.00"));
